...
char NAME_F24[] = "F24";
char NAME_INTL1[] = "Ro";
char NAME_INTL2[] = "Katakana/Hiragana";
char NAME_INTL3[] = "Yen";
...
DEFINEXTKEY(MEDIANEXT, 71, 1, 2, 1),
DEFINEXTKEY(MEDIAPREV, 63, 1, 2, 1),
DEFINEXTKEY(MEDIASTOP, 66, 1, 1, 1),
DEFINEXTKEY(MEDIAPLAY, 68, 1, 2, 1),
DEFINEXTKEY(MEDIAMUTE, 78, 1, 1, 1),
DEFINEXTKEY(MEDIAVOLUP, 74, 1, 1, 1),
DEFINEXTKEY(MEDIAVOLDN, 76, 1, 1, 1),
DEFINEXTKEY(MEDIASEL, 63, 3, 3, 1),
DEFINEXTKEY(MEDIAMAIL, 67, 3, 4, 1),
DEFINEXTKEY(MEDIACALC, 72, 3, 4, 1),
DEFINEXTKEY(MEDIACOMP, 77, 3, 2, 1),
DEFINEXTKEY(WWWSEARCH, 65, 6, 6, 1),
DEFINEXTKEY(WWWHOME, 72, 6, 6, 1),
DEFINEXTKEY(WWWBACK, 65, 8, 2, 1),
DEFINEXTKEY(WWWFORWARD, 69, 8, 2, 1),
DEFINEXTKEY(WWWSTOP, 72, 8, 6, 1),
DEFINEXTKEY(WWWREFRESH, 65, 10, 6, 1),
DEFINEXTKEY(WWWFAV, 72, 10, 6, 1),
DEFINEXTKEY(SYSPOWER, 65, 13, 3, 1),
DEFINEXTKEY(SYSSLEEP, 69, 13, 4, 1),
DEFINEXTKEY(SYSWAKE, 74, 13, 4, 1),
};