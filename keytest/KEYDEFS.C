...
{XT_KEY_AMSTRAD_PADEN_MAKE, XT_KEY_AMSTRAD_PADEN_BREAK, NULL, NULL, NAME_AMSTRAD_PADEN, 57, 12, 2, 5 },
{XT_KEY_AMSTRAD_RDEL_MAKE, XT_KEY_AMSTRAD_RDEL_BREAK, NULL, NULL, NAME_AMSTRAD_RDEL,  35, 10, 3, 2 }
};